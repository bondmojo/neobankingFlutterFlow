...
import '../phone_input_screen/phone_input_screen_widget.dart';
                                        ...
                                        Expanded(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '1635adwt' /* Avail Credit Line instantly an... */,
                                            ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'sbfuo8z6' /* Withdraw your Credit as and wh... */,
                                            ),
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle1,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '88efbvx5' /* Earn Gojo Coins and enjoy amaz... */,
                                            ),
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle1,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'z2s05hvg' /* Refer & Earn by inviting your ... */,
                                            ),
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle1,
                    ...
                    onPressed: () async {
                      await Navigator.push(
                        ...
                        PageTransition(
                          ...
                          child: PhoneInputScreenWidget(),
                        ),
                      );
                    },
                    text: FFLocalizations.of(context).getText(
                      '5tihbxc8' /* Get Started */,
                    ),
